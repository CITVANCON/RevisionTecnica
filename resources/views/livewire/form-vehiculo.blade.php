        ...
        <x-dialog-modal wire:model="busqueda">
            ...
            <x-slot name="content">
                @if ($vehiculos)
                    ...
                    <p class="text-xs text-slate-500 text-center">Selecciona uno de estos vehiculos para agregarlo a la
                        inspección.</p>
                @endif
            </x-slot>
            <x-slot name="footer">
                <x-secondary-button wire:click="$set('busqueda',false)" class="mx-2">
                    Cancelar
                </x-secondary-button>
            </x-slot>
        </x-dialog-modal>
