                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        @can('usuarios.permisos')
                                            <x-responsive-nav-link class="text-sm" href="{{ route('usuarios.permisos') }}"
                            ...
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-accent focus:bg-accent rounded"
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        @can('dashboardAsistencia')
                                                <x-responsive-nav-link class="text-sm" href="{{ route('dashboardAsistencia') }}"
                                                    :active="request()->routeIs('dashboardAsistencia')">
                                                    Dashboard
                                                </x-responsive-nav-link>
                                        @endcan
                                        @can('horarioEmpleados')
                                                <x-responsive-nav-link class="text-sm" href="{{ route('horarioEmpleados') }}"
                                                    :active="request()->routeIs('horarioEmpleados')">
                                                    Horarios
                                                </x-responsive-nav-link>                                         
                                        @endcan
                                        @can('reporteAsistencia')
                                                <x-responsive-nav-link class="text-sm"
                                                    href="{{ route('reporteAsistencia') }}" :active="request()->routeIs('reporteAsistencia')">
                                                    Asistencias
                                                </x-responsive-nav-link>
                                        @endcan
                                        @can('AsignarHorario')
                                                <x-responsive-nav-link class="text-sm" href="{{ route('AsignarHorario') }}"
                                                    :active="request()->routeIs('AsignarHorario')">
                                                    Horarios Usuarios
                                                </x-responsive-nav-link>
                                        @endcan
                                        @can('autorizarDispositivo')
                                                <x-responsive-nav-link class="text-sm" href="{{ route('autorizarDispositivo') }}"
                                                    :active="request()->routeIs('autorizarDispositivo')">
                                                    Terminales
                                                </x-responsive-nav-link>
                                        @endcan                                                                                        
                                    </ul>
