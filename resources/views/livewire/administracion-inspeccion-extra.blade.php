        ...
        <div class="pb-6">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
                <div class="px-2">
                    <h2 class="text-gray-600 font-semibold text-2xl">
                        <i class="fas fa-clipboard-check mr-2"></i>Gestión de Inspecciones Extras
                    </h2>
                    <span class="text-xs">Monitoreo de resultados de inspecciones Hermeticidas, Opacidad, etc.</span>
                </div>
            ...
            <div class="w-full items-center md:flex md:justify-between space-y-4 md:space-y-0 md:space-x-4 px-2">
                <div class="flex flex-wrap gap-3">
                    <div class="flex bg-gray-50 items-center p-2 rounded-md shadow-sm border border-gray-100">
                        <span>Estado:</span>
                        <select wire:model.live="resultado_final"
                            ...
                            <tr class="border-b border-gray-200 bg-white text-sm"
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center">
                                        <div>
                                            <p class="text-gray-900 font-bold uppercase">{{ $item->vehiculo->placa ?? 'NE' }}</p>
                                            <p class="text-indigo-600 text-xs font-semibold">
                                                {{ $item->vehiculo->categoria ?? 'NE' }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-5 py-4">
                                    <p class="text-gray-700 text-xs font-medium uppercase">
                                        {{ $item->tipoServicio->nombre_servicio ?? 'NE' }}
                                    </p>
                                ...
                                <td class="px-5 py-4 text-center">
                                    <div class="flex flex-row items-center justify-center gap-2">
                                        <span
                                            ...
                                            {{ $item->resultado_final == 'APROBADO'
                                                ? 'bg-green-100 text-green-700 border border-green-200'
                                                : ($item->resultado_final == 'DESAPROBADO'
