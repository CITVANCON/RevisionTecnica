<div class="max-w-5xl m-auto  bg-white rounded-lg shadow-md" id="datosVehiculo">
    ...
    <div class="mt-2 mb-6 px-8 py-2">
        <div class="mb-2">
            ...
            <x-input type="text" class="w-full" wire:model="vehiculo.propietario" maxlength="245" disabled />
            <x-input-error for="propietario" />
        </div>
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div>
                <x-label value="Placa:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.placa" maxlength="7" disabled />
            ...
            <div>
                <x-label value="Marca:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.marca" disabled />
                <x-input-error for="marca" />
            </div>
            <div>
                <x-label value="Modelo:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.modelo" disabled />
                <x-input-error for="modelo" />
            </div>
            <div>
                <x-label value="Año de fabricación:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.anio_fabricacion" type="number" disabled />
            ...
            <div>
                ...
                <x-input type="text" class="w-full" wire:model="vehiculo.combustible" disabled />
                <x-input-error for="combustible" />
            </div>
            <div>
                <x-label value="VIN / N° Serie:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.vin_serie" disabled />
                <x-input-error for="vin_serie" />
            </div>
            <div>
                <x-label value="N° Serie Motor:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.numero_motor" disabled />
                <x-input-error for="numero_motor" />
            </div>

            <div>
                <x-label value="Carroceria:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.carroceria" disabled />
                <x-input-error for="carroceria" />
            </div>
            <div>
                <x-label value="Marca carroceria:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.marca_carroceria" disabled />
                <x-input-error for="marca_carroceria" />
            </div>
            <div>
                <x-label value="Color:" />
                <x-input type="text" class="w-full" wire:model="vehiculo.color" disabled />
                <x-input-error for="color" />
            </div>
            <div class="flex flex-row">
                <div class="w-1/2">
                    <x-label value="Ejes:" />
                    <x-input type="text" class="w-5/6" wire:model="vehiculo.ejes" type="number" disabled />
                    <x-input-error for="ejes" />
                </div>
                <div class="w-1/2">
                    <x-label value="Ruedas:" />
                    <x-input type="text" class="w-5/6" wire:model="vehiculo.ruedas" type="number" disabled />
            ...
            <div class="flex flex-row">
                <div class="w-1/2">
                    ...
                    <x-input type="text" class="w-5/6" wire:model="vehiculo.asientos" type="number" disabled />
            ...
            <div class="flex flex-row w-full justify-center m-auto">
                <div class="w-1/3">
                    <x-label value="Largo:" />
                    <x-input type="text" class="w-5/6" wire:model="vehiculo.largo" type="number" disabled />
                    <x-input-error for="largo" />
                </div>
                <div class="w-1/3">
                    <x-label value="Ancho:" />
                    <x-input type="text" class="w-5/6" wire:model="vehiculo.ancho" type="number" disabled />
                    <x-input-error for="ancho" />
                </div>
                <div class="w-1/3">
                    <x-label value="Altura:" />
                    <x-input type="text" class="w-5/6" wire:model="vehiculo.alto" type="number" disabled />
            ...
            <div class="flex flex-row w-full justify-center m-auto">
                <div class="w-1/3">
                    ...
                    <x-input type="text" class="w-5/6" wire:model="vehiculo.peso_neto" type="number" disabled />
